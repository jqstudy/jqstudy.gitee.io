...
&ensp;&ensp;一些 DOM 的操作或者属性访问可能会引起页面的回流和重绘，从而引起性能上的消耗。
...
#### 35. 请描述一下 cookies，sessionStorage 和 localStorage 的区别？
